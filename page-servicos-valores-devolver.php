<?php /*Template Name: SERV | VALORES */ ?>
<?php get_header(); ?>
...
<article class="page-servicos internas valores">
	...
	<div class="bloco-banner animated fadeIn">
		...
		<header class="bloco-header vPadding iconYes">
			<i class="icon"></i>
			<h4 class="bloco-header__toptitle">VALORES A</h4>
			<h2 class="bloco-header__title">DEVOLVER</h2>
