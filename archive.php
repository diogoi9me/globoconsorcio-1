...
<article class="page-blog internas leftMain blogContainer">
	...
	<div class="bloco-banner animated fadeIn">
	      ...
	      <div class="bloco__title-banner">
		      <div class="line line-1">
			        <div class="currentTitle">
			        	<h4 class="bloco-banner__titletopo">BLOG / ARQUIVO</h4>
		        		<h2 class="bloco-banner__title bloco-banner__title--facil animated fadeIn"><?php the_archive_title(); ?></h2>
		        	</div>
	        	</div>
		...
		<header class="bloco-header vPadding hPadding_2 container-single">
			<h4 class="bloco-header__toptitle">ARQUIVO</h4>
			<h2 class="bloco-header__title"><?php the_archive_title(); ?></h2>
