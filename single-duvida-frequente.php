	      ...
	      <div class="bloco__title-banner">
		      <div class="line line-1">
		        <div class="currentTitle">
			        <h4 class="bloco-banner__titletopo">DÚVIDAS FREQUENTES (FAQ)</h4>
  ...
  <div class="container colls colls-2 separator">
      ...
      <div class="filtro coll duvida filtro__ativo">
		...
		<!-- <header class="bloco-header">
			<h4 class="bloco-header__toptitle">TIRE AS SUAS</h4>
			<h2 class="bloco-header__title">DÚVIDAS</h2>
		</header> -->
		...
		<header class="bloco-header">
			<h4 class="bloco-header__toptitle">ENCONTRE OUTRAS</h4>
