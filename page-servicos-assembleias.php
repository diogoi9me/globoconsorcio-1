<?php /*Template Name: SERV | ASSEMBLEIAS */ ?>
<?php get_header(); ?>
...
<article class="page-servicos internas assembleias">
	...
	<div class="bloco-banner animated fadeIn">
		...
		<header class="bloco-header vPadding iconYes">
			<i class="icon"></i>
			<h4 class="bloco-header__toptitle">DATAS DE</h4>
			<h2 class="bloco-header__title">ASSEMBLEIAS</h2>
