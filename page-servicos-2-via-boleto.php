<?php /*Template Name: SERV | BOLETOS */ ?>
<?php get_header(); ?>
...
<article class="page-servicos internas boletos">
	...
	<div class="bloco-banner animated fadeIn">
		...
		<header class="bloco-header vPadding iconYes">
			<i class="icon"></i>
			<h4 class="bloco-header__toptitle">2ª VIA DE</h4>
			<h2 class="bloco-header__title">BOLETOS</h2>
